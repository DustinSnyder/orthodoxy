  ...
  return (
    <div className="space-y-4 pb-10">
      ...
      {scripturePaths.map((path) => (
        <section key={path.id} className="rounded-2xl border border-orthodox-gold/35 bg-orthodox-deep p-4">
          ...
          <ul className="mt-3 space-y-2">
            {path.chapters.map((c) => (
              <li key={c.ref} className="rounded-xl border border-orthodox-gold/25 px-3 py-2 text-sm">
