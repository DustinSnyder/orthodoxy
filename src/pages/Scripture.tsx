...
export function Scripture() {
  ...
  return (
    <div className="space-y-4 pb-10">
      <h1 className="font-display text-3xl text-orthodox-gold-light">Scripture</h1>
      ...
      <section className="rounded-2xl border border-orthodox-gold/25 bg-orthodox-deep p-4">
        ...
        <ul className="space-y-2">
          {dailyEntries.map((d) => (
            <li key={d.date} className="rounded-xl bg-orthodox-navy/50 px-3 py-2 text-sm">
      ...
      {scripturePaths.map((path) => (
        <section key={path.id} className="rounded-2xl border border-orthodox-gold/25 bg-orthodox-deep p-4">
          ...
          <ul className="mt-3 space-y-2">
            {path.chapters.map((c) => (
              <li key={c.ref} className="rounded-xl border border-orthodox-gold/15 px-3 py-2 text-sm">
